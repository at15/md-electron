...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    define(["..//codemirror", "../htmlmixed/htmlmixed", "../clike/clike"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
  "use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    define(["..//codemirror", "../markdown/markdown", "../../addon/mode/overlay"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
"use strict";
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    define(["..//codemirror", "../htmlmixed/htmlmixed", "../smarty/smarty"], mod);
  else // Plain browser env
    mod(CodeMirror);
})(function(CodeMirror) {
"use strict";
